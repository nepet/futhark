...
/// TimeLimitChecker implements a `futhark::Check` that is called to check if
...
struct TimeLimitChecker {}

impl Check for TimeLimitChecker {
...
fn main() {
    ...
    checks.insert("before".to_string(), Box::new(TimeLimitChecker {}));
